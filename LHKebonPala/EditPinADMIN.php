  ...
  <div id="app">
    <v-app>
      <v-main>
          ...
          <center>
            <form method="post" action="updatepin.php">
              ...
              <div class="form-group">
                <input type="number" class="form-control" name="PIN" value="<?php echo $fetch['PIN'] ?>"
                  required="required" />
              </div>
              ...
              <input class="btn btn-warning" type="submit" id="tst" name="update" value="Update">
        ...
        <footer id="footerBar" style="margin-top: 60vh">
          <div id="txtCopy">
