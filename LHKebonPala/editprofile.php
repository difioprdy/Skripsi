<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    $query = "UPDATE usersadminlh SET firstname = '$fname', lastname = '$lname', studentno = '$studentno'
...
<body>
  ...
  <section>
    ...
    <center><strong class="title">Edit Profile</strong></center>
...
<div class="form-group">
          <label for="oldpass">User ID</label>
          <input type="text" value="<?php echo $fetch["username"] ?>" class="form-control" name="username">
        </div>
