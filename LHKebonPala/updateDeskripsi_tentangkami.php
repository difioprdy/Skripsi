...
if(isset($_GET['id'])){
    ...
    header('Location : TentangKamiLH_ADMIN.php?success=0');
}
...
<div class="container">
                    <!-- baru -->
                    <center>
    <h3 style="font-family:'Monserat'">Update Deskripsi Tentang Kami</h3>
    <br>
    <form action="update_post_deskripsi_tentangkami.php" method="post">
        <textarea class="ckeditor" name="editor">
            <?php $query = mysqli_query($conn, "SELECT * FROM tentangkami_deskripsi_homepage_lh WHERE id= '$id'");
        ...
        <br>
        <button class="btn btn-warning" type="submit" id="btnupdate">Update</button>
    </form>
