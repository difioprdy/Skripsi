    ...
    $calendar.= "<a class='btn btn-xs btn-primary' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Bulan Depan</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
         ...
         if($date<date('Y-m-d')){
             ...
             $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='book_ruangserbagunaADMIN.php?date=".$date."' class='btn btn-success btn-xs'>Book</a>";
         }
...
<body>
    ...
    <h1><center><strong>Booking Ruang Serba Guna</strong></center></h1>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php
