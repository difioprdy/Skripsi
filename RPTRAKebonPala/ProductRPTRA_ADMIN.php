...
<body>
    ...
    <h3 class="text-primary" style=" text-align: center; color:#727272; margin-bottom: 80px; font-family: Monserat;">
        Atur Product PKK Mart
        RPTRA Kebon Pala</h3>
    ...
    <button class="btn btn-success" type="button" data-toggle="modal" data-target="#form_modal"><span
            class="glyphicon glyphicon-plus"></span> Tambah Product</button>
    <br /><br />
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button type="button" id="btnupdate"><a style="color:white"
                            href="<?= 'updateProduct_RPTRA.php?id=' .$fetch['id'] ?>">Update</a></button>
                ...
                <form method="POST" action="ProductRPTRA_save.php" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <input type="hidden" value="" class="form-control" name="nama_foto_hidden" required="required" />
                            </div>
                        </div>
                    </div>
                    <br style="clear:both;" />
