...
if(isset($_POST['submit'])){
    ...
    if($stmt->execute()){
        ...
        if($result->num_rows>0){
            ...
            $msg = "<div class='alert alert-success'>Lapangan Futsal pada jam $timeslot telah di-nonaktifkan untuk dibooking</div>
            ";
            $bookings[] = $timeslot;
            $stmt->close();
            $mysqli->close();
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="hidden" type="text"
                            value="Tempat ini di-nonatkifkan untuk booking oleh pengurus RPTRA Kebon Pala"
                        ...
                        <div class="col-md-12">
                            <form action="" method="post">
                                ...
                                <div class="form-group pull-right">
                                    <button id="btnupdate" type="type">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
