<?php 
  ...
  if(isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM usersadminrptra WHERE username = '$uname'";
  ...
  if(isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM usersadminrptra WHERE password = '$password'";
...
<body>
    ...
    <div id="navBar">
      ...
      <div id="navBtn">
        <ul>
          ...
          <li><a style="color:#32CD32" href="index.php">Login</a></li>
        </ul>
      </div>
  </header>
  ...
  <strong class="title">Forgot Password/User ID</strong><br>
    <strong>Masukkan User ID</strong>
