...
<body>
    <div id="app">
        <v-app>
            ...
            <v-btn text color="red"><a style="color: red;" href="Login.php">Logout</a></v-btn><br>
                ...
                <div class="container">
                    ...
                    <h3 class="text-primary" style="font-family: Monserat;">Edit Deskripsi Headline Homepage</h3>
        ...
        <br>
                        ...
                        <button style="color:white" class="btn btn-primary" type="submit" id="tst" name="save">Update</button>
                    </form>
